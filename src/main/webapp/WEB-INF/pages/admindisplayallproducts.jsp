									    ...
									    <table class="table table-bordered table-hover" id="tablesortsearch">
									      ...
									      <tbody>
									       <c:forEach var="product" items="${productslist}">
												...
												<td><img src="resources/images/products/${product.product_id}.png" height="120px" width="160px" class="img-responsive"> </td>
												<td>${product.product_name}</td>
												<td>${product.product_desc}</td>
												<td>${product.product_isenabled}</td>
												<td><a href="adminreqtoeditproduct?product_id=${product.product_id}" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i></a> <a href="adminreqtodeleteproduct?product_id=${product.product_id}" class="btn btn-primary"><i class="fa fa-trash" aria-hidden="true"></i></a>
												</td>
												</tr>
											</c:forEach>
									      </tbody>
