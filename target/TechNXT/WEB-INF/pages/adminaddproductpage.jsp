    			...
    			<div class="container-fluid" >
    				...
    				<div class="ibox">
                        ...
                        <div class="ibox-content">
                                   <div>
                                      <form:form action="adminaddproducttodb" commandName="productobj" method="POST" enctype="multipart/form-data">
										 <div class="form-group row">
				    					 	<form:label path="product_name" class="col-lg-2">Product Name</form:label>
				    					 	<div class="col-lg-10">
				    					 		<form:input path="product_name" placeholder="Product name" class="form-control" />
				    					 	</div>
				    					 </div>
				    					 <div class="form-group row">
				    					 	<form:label path="product_desc" class="col-lg-2">Product Description</form:label>
				    					 	<div class="col-lg-10">
				    					 		<form:input path="product_desc" placeholder="Product description" class="form-control" />
				    					 	</div>
				    					 </div>
				    					 <div class="form-group row">
				    					 ...
				    					 <div class="col-lg-10">
				    					 	<form:input path="product_image" type="file" />
				    					 </div>
				    					 </div>
