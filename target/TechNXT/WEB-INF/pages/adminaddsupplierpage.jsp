    			...
    			<div class="container-fluid">
    				...
    				<div class="ibox">
                        ...
                        <div class="ibox-content">
                                   <div>
                                      <form:form action="adminaddsuppliertodb" commandName="supplierobj" method="POST" enctype="multipart/form-data">
										 <div class="form-group row">
				    					 	<form:label path="supplier_name" class="col-lg-2">Supplier Name</form:label>
				    					 	<div class="col-lg-10">
				    					 		<form:input path="supplier_name" placeholder="Supplier name" class="form-control" />
				    					 	</div>
				    					 </div>
				    					 <div class="form-group row">
				    					 	<form:label path="supplier_desc" class="col-lg-2">Supplier Description</form:label>
				    					 	<div class="col-lg-10">
				    					 		<form:input path="supplier_desc" placeholder="Supplier description" class="form-control" />
				    					 	</div>
				    					 </div>
				    					 <div class="form-group row">
				    					 ...
				    					 <div class="col-lg-10">
				    					 	<form:input path="supplier_image" type="file" />
				    					 </div>
				    					 </div>
